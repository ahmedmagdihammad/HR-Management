    ...
    <div class="col-xs-12">
      <div class="box box-info">
        <div class="box-header">
          ...
          <h3 class="box-title">Call Center List :  {{$customers->name}}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          @if(count($callcenters)>0)
          	<table id="" class="table table-bordered table-hover">
	            ...
	            @if($callcenter->getCustomer['id'] == $id)
	              <tr>
				      ...
				      <div class="modal-dialog">
				        <div class="modal-content">
				          <div class="modal-header">
				            ...
				            <form method="POST" action="{{route('call_center.edit', $callcenter->id)}}" enctype="multipart/form-data">
					              ...
					              {{csrf_field()}}
					              	<div class="form-group hidden">
						                <div class="row">
						                  ...
						                  <div class="col-md-10">
						                  	<input class="form-control" type="text" name="upcustomer_id" value="{{$customers->id}}">
						                  </div>
						                </div>
					              	</div>
				      ...
				      <div class="modal-dialog">
				        <div class="modal-content">
				          <div class="modal-header">
				            ...
				            <form method="POST" action="{{route('call_center.delete', $callcenter->id)}}" enctype="multipart/form-data">
					          <div class="modal-body">
					              {{csrf_field()}}
					              <div class="form-group">
					                <div class="row">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form method="POST" action="{{route('call_center.store')}}" enctype="multipart/form-data">
	          <div class="modal-body">
	              {{csrf_field()}}
	              <div class="form-group hidden">
		                <div class="row">
		                  ...
		                  <div class="col-md-10">
		                    <input class="form-control" type="text" name="customer_id" id="customer_id" value="{{$customers->id}}">
		                  </div>
		                </div>
	              </div>
	              <div class="form-group">

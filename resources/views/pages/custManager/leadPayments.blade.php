    ...
    <div class="col-xs-12">
      <div class="box box-info">
        <div class="box-header">
          ...
          <h3 class="box-title">Payments List : {{$lead->name_en}}</h3>
        </div>
        <!-- /.box-header -->
        <div class=" box-body">
          @if(count($payments)>0)
	            ...
	            <tbody>
		            @foreach($payments as $payment)
		              <tr>
		                ...
		                <td>@if($payment->getEmployee->getBranch['name'] == '') -- @else {{$payment->getEmployee->getBranch['name']}} @endif</td>
						          ...
						          <div class="modal-body">
						              ...
						              <div class="form-group hidden">
						                <div class="row">
						                  ...
						                  <div class="col-md-10">
						                    <input class="form-control" type="text" name="upcustomer_id" id="upcustomer_id" value="{{$lead->id}}" required="">
						                  </div>
						                </div>
						              </div>
						              ...
						              <div class="form-group">
						                <div class="row">
						                	<div class="col-md-2">
						                  	...
						                  	<div class="col-md-4">
						                  		<p>{{$payment->getCustomer['name_en']}}</p>
						                  	</div>
						                  	<div class="col-md-2">
						                    	<label for="exampleInputEmail1">Image </label>
						                  	</div>
						                ...
						                <hr>
					                  	<div class="row">
						                  	...
						                  	<div class="col-md-4">
						                  		<p>{{$payment->getEmployee['name']}}</p>
						                  	</div>
						                  	<div class="col-md-2">
						                    	<label for="exampleInputEmail1">Branch </label>
						                  	</div>
						                  	<div class="col-md-4">
						                  		<p>@if($payment->getEmployee->getBranch['name'] == '') -- @else {{$payment->getEmployee->getBranch['name']}} @endif</p>
						                  	</div>
					                  	</div>
						              </div>
						          </div>
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form method="POST" action="{{route('lead.payment.store', $lead->id)}}" enctype="multipart/form-data">
	          <div class="modal-body">
				  {{csrf_field()}}
				  <div class="form-group">
	                <div class="row">

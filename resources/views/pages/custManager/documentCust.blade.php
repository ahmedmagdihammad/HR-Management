    ...
    <div class="col-xs-12">
      <div class="box box-info">
        <div class="box-header">
          ...
          <h3 class="box-title">Documents List :  {{$customers->name}}</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
				      ...
				      <div class="modal-dialog">
				        <div class="modal-content">
				          <div class="modal-header">
				            ...
				            <form method="POST" action="{{route('documentCust.edit', $document->id)}}" enctype="multipart/form-data">
					          <div class="modal-body">
					              ...
					              <div class="form-group hidden">
					                <div class="row">
					                  ...
					                  <div class="col-md-10">
					                    <input class="form-control" type="text" name="uptype" id="uptype" value="c" required="">
					                  </div>
					                </div>
					              </div>
					              <div class="form-group hidden">
					                <div class="row">
					                  ...
					                  <div class="col-md-10">
					                  	<input class="form-control" type="text" name="name" value="{{$customers->id}}">
					                  </div>
					                </div>
					              </div>
				      ...
				      <div class="modal-dialog">
				        <div class="modal-content">
				          <div class="modal-header">
				            ...
				            <form method="POST" action="{{route('documentCust.delete', $document->id)}}" enctype="multipart/form-data">
					          <div class="modal-body">
					              {{csrf_field()}}
					              <div class="form-group">
					                <div class="row">
      ...
      <div class="modal-dialog">
        <div class="modal-content">
          <div class="modal-header">
            ...
            <form method="POST" action="{{route('documentCust.store')}}" enctype="multipart/form-data">
	          <div class="modal-body">
	              {{csrf_field()}}
	              <div class="form-group hidden">
	                <div class="row">
	                  ...
	                  <div class="col-md-10">
	                    <input class="form-control" type="type" name="type" id="type" value="c" required="">
	                  </div>
	                </div>
	              </div>
	              <div class="form-group hidden">
	                <div class="row">
	                  ...
	                  <div class="col-md-10">
	                    <input class="form-control" type="text" name="recid" id="recid" value="{{$customers->id}}">
	                  </div>
	                </div>
	              </div>
	              <div class="form-group">

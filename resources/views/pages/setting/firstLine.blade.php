...
@endsection
@section('breadcrumb')
	<i class="fa fa-credit-card"></i> First line
@endsection
@section('namepage')
  First line
@endsection
    ...
    <div class="col-xs-12">
      <div class="box box-info">
        <div class="box-header">
          <h3 class="box-title">First Line List</h3>
        </div>
        <!-- /.box-header -->
        <div class="box-body">
          @if(count($payments)>0)
					          ...
					          <div class="modal-body">
					              ...
					              <div class="form-group hidden">
					                <div class="row">
					                  ...
					                  <div class="col-md-10">
					                  	<input class="" type="text" name="upcustomer_id" id="upcustomer_id" value="{{$payment->getCustomer['id']}}">
					                  </div>
					                </div>
					              </div>
					              <div class="form-group hidden">
